...
"""11-student.py:
Student class with to_json method and reload_from_json method
"""
...
class Student:
    ...
    def reload_from_json(self, json):
        """Rebuilds the student instance from a json object
        Args:
            json (dict): dictionary with updated values
        """
        student = self.__dict__

        for key in student:
            if key in json:
                student[key] = json.get(key)
